...
def colo_embedding_bag_1Dcol(
    ...
    output_parallel = F.embedding_bag(
        input_tensor,
        weight,
        offsets=offsets,
        max_norm=max_norm,
