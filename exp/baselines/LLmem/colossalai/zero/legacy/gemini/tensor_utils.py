...
def colo_tensor_mem_usage(
    tensor: Union[torch.Tensor, StatefulTensor]
) -> Tuple[int, int]:
...
def colo_model_data_tensor_move(
    src_t: Union[StatefulTensor, torch.Tensor],
...
def colo_model_tensor_clone(
    t: Union[StatefulTensor, torch.Tensor], target_device: torch.device
) -> torch.Tensor:
    """
