...
class Estimator(EstimatorInterface):
    def __init__(
        ...
        data_x: torch.Tensor,
        data_y: torch.Tensor,
        max_est_memory_in_bytes: Optional[int] = None,
        ...
        if max_est_memory_in_bytes is None:
            max_est_memory = 24
        else:
            max_est_memory = max_est_memory_in_bytes/1024**3
        s_time = time.time_ns()
        ...
        self._max_gpu_memory = max_est_memory
    ...
    def estimate(self):
        ...
        exe_time = time.time_ns() - s_time
        self._execute_time += exe_time
        self._alloc = _result
